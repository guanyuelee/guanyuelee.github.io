...
excerpt:
    <h3>Check out if you are interested in following questions:</h3>
    <p>   how to analyze pre-trained generator's knowledge? </p>
    <p>   how to find a target image in the pre-trained generator? </p>
    <p>   how to manipulate your images? </p>
